...
#
#mod_svar_irf <- custom_svars_irf(main_svar, n.ahead = n.ahead)
#mod_svar_irf <- irf(main_svar, n.ahead = n.ahead)
#
#plot(mod_svar_irf)
#svars:::irf.svars()
...
#max.iter <- 79
#SVAR2(ba_var$before, Amat = amat2, max.iter = max.iter, estmethod = method, lrtest = FALSE,
#      conv.crit = 0.1e-3)


#irf(ba_svar$after_vac, n.ahead = n.ahead, ortho = TRUE, cumulative = TRUE, runs = runs)