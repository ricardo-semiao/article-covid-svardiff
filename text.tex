...
% Cores:
\usepackage{xcolor}
\makeatletter % criar paleta "Dark2" do RColorBrewer (pacote do R)
\newcounter{j}
...
\input{scripts/configs.tex} % outras configurações em arquivo separado
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.95\textwidth]{figures/res2_cf_1_2.png}
    \label{fig:counter1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \caption{Contrafactuais (i*) e (ii*)}
    \includegraphics[width = 0.95\textwidth]{figures/res2_cf_4_5.png}
    \label{fig:counter2}
\end{figure}
...
\begin{figure}[H]
   ...
   \includegraphics[width = 0.95\textwidth]{figures/res2_cf_3_6.png}
   \label{fig:counter3}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.95\textwidth]{figures/diag_fit_res.png}
    \label{fig:varfit}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.95\textwidth]{figures/diag_disp_dist.png}
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.95\textwidth]{figures/diag_stab.png}
    \label{fig:varstab}
\end{figure}
...
\begin{figure}[H]
    ...
    \includegraphics[width = 0.95\textwidth]{figures/ap_irfs.png}
    \label{fig:apirf}
\end{figure}
